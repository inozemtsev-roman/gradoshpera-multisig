...
export const lockTypeToDescription = (lockType: LockType) => {
  switch (lockType) {
    ...
    case "out":
      return "Исходящие транзакции заблокированы";
    case "in":
      return "Входящие транзакции заблокированы";
    case "full":
      return "Исходящие и входящие транзакции заблокированы";
  }
};
...
export function jettonMinterConfigCellToConfig(
  config: Cell
